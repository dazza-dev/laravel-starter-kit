...
class UserRequest extends FormRequest
{
    ...
    /**
     * Validation rules for creating or updating a user: password is required only when creating.
     */
    public function rules(): array
    {
        ...
        return [
            ...
            // Optional: assumed active on create, kept as-is on edit.
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in' => __('users::validation.status.in'),
